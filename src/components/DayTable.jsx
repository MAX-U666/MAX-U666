  ...
  const getCellColor = (key, row) => {
    switch (key) {
      ...
      case 'revenue_ready':
        return '#10B981';
      case 'roi':
        return row.roi >= 3 ? '#10B981' : row.roi > 0 ? '#F59E0B' : '#8E8E93';
      case 'manual_orders':
        return '#8B5CF6';
      default:
        return '#3C3C43';
    ...
    <div style={{ ...styles.card, background: 'rgba(255,255,255,0.02)' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <span style={{ fontSize: '14px', fontWeight: '700', color: '#1C1C1E' }}>7天数据追踪</span>
          ...
          <div style={{ display: 'flex', gap: '4px', marginLeft: '16px' }}>
            <button 
              ...
              style={{
                ...
                color: viewMode === 'compact' ? '#FF6B35' : '#8E8E93',
                fontSize: '11px',
                cursor: 'pointer'
              }}
            >
            ...
            <button 
              ...
              style={{
                ...
                color: viewMode === 'full' ? '#FF6B35' : '#8E8E93',
                fontSize: '11px',
                cursor: 'pointer'
              }}
            >
        ...
        <div style={{ display: 'flex', gap: '20px', fontSize: '12px', color: '#3C3C43' }}>
      ...
      {/* 提示 */}
      <div style={{ padding: '8px 20px', borderTop: '1px solid #D1D1D6', fontSize: '10px', color: '#8E8E93', textAlign: 'center' }}>
        💡 点击任意行查看该天的 AI 决策分析
      </div>
    </div>
  );
