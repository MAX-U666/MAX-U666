  ...
  const getCellColor = (key, row) => {
    switch (key) {
      ...
      case 'revenue_ready':
        return '#10B981';
      case 'roi':
        return row.roi >= 3 ? '#10B981' : row.roi > 0 ? '#F59E0B' : '#86868B';
      case 'manual_orders':
        return '#8B5CF6';
      default:
        return '#6E6E73';
    ...
    <div style={{ ...styles.card, background: 'rgba(255,255,255,0.02)' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <span style={{ fontSize: '14px', fontWeight: '700', color: '#1D1D1F' }}>7天数据追踪</span>
          ...
          <div style={{ display: 'flex', gap: '4px', marginLeft: '16px' }}>
            <button 
              ...
              style={{
                ...
                color: viewMode === 'compact' ? '#FF6B35' : '#86868B',
                fontSize: '11px',
                cursor: 'pointer'
              }}
            >
            ...
            <button 
              ...
              style={{
                ...
                color: viewMode === 'full' ? '#FF6B35' : '#86868B',
                fontSize: '11px',
                cursor: 'pointer'
              }}
            >
        ...
        <div style={{ display: 'flex', gap: '20px', fontSize: '12px', color: '#6E6E73' }}>
      ...
      {/* 提示 */}
      <div style={{ padding: '8px 20px', borderTop: '1px solid rgba(0,0,0,0.06)', fontSize: '10px', color: '#86868B', textAlign: 'center' }}>
        💡 点击任意行查看该天的 AI 决策分析
      </div>
    </div>
  );
